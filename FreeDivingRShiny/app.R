#Group Latte:
#2361095 Aybuke Altuntas
#2361061 Gozde Akkaya
#2361178 Gulnaz Cavusoglu
#2361293 Hatice Kubra Gulcan
...
ui <- fluidPage(
    ...
    sidebarLayout(
        sidebarPanel(
            ...
            h5("Group Members:"),
            h6("Aybuke Altuntas 2361095"),
            h6("Gozde Akkaya 2361061 "),
            h6("Gulnaz Cavusoglu 2361178"),
            h6("Hatice Kubra Gulcan 2361293")
